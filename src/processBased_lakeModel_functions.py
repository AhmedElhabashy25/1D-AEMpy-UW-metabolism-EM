...
def wq_initial_profile(initfile, nx, dx, depth, volume, startDate, doc_guess=None):
  #meteo = processed_meteo
  #startDate = meteo['date'].min()
  obs = pd.read_csv(initfile)
  obs['datetime'] = pd.to_datetime(obs['datetime'])
  ...
  # ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
  # AE Change:  if no doc, create a constant doc array
  if (not doc_obs.empty) or (not doc_guess is None):
          doc_obs['datetime'] = do_obs['datetime']
          doc_obs['observation'] = len(do_obs['datetime']) * [doc_guess]
  # ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
